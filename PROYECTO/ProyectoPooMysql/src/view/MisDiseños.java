...
public class MisDiseños extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botonCargar.setFont(new java.awt.Font("Roboto Black", 0, 12)); // NOI18N
        botonCargar.setForeground(new java.awt.Color(104, 104, 104));
        botonCargar.setText("Cargar datos de Base de Datos");
        botonCargar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonCargarActionPerformed(evt);
            }
        });
        mainPanel.add(botonCargar, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 460, -1, -1));
